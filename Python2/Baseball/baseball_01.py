...
def create_db(db_name):
    ...
    Pitching = SA.Table('Pitching', metadata,
                        SA.Column('playerID', SA.String(64)),
                        SA.Column('yearID', SA.Integer()),
                        SA.Column('stint', SA.Integer()),
                        SA.Column('teamID', SA.String(64)),
                        ...
                        SA.Column('G', SA.Integer()),
                        SA.Column('GS', SA.Integer()),
                        SA.Column('CG', SA.Integer()),
                        SA.Column('SHO', SA.Integer()),
                        SA.Column('SV', SA.Integer()),
                        SA.Column('IPouts', SA.Integer()),
                        SA.Column('H', SA.Integer()),
                        SA.Column('ER', SA.Integer()),
                        SA.Column('HR', SA.Integer()),
                        SA.Column('BB', SA.Integer()),
                        SA.Column('SO', SA.Integer()),
                        SA.Column('BAOpp', SA.Integer()),
                        SA.Column('ERA', SA.Integer()),
                        SA.Column('IBB', SA.Integer()),
                        SA.Column('WP', SA.Integer()),
                        SA.Column('HBP', SA.Integer()),
                        SA.Column('BK', SA.Integer()),
                        SA.Column('BFP', SA.Integer()),
    ...
    PitchingPost = SA.Table('PitchingPost', metadata,
                            SA.Column('playerID', SA.String(64)),
                            SA.Column('yearID', SA.Integer()),
                            SA.Column('round', SA.String(64)),
                            SA.Column('teamID', SA.String(64)),
    ...
    Salaries = SA.Table('Salaries', metadata,
                        SA.Column('yearID', SA.Integer()),
                        SA.Column('teamID', SA.String(64)),
                        SA.Column('lgID', SA.String(64)),
                        SA.Column('playerID', SA.String(64)),
    ...
    Schools = SA.Table('Schools', metadata,
                       SA.Column('schoolID', SA.String(64)),
                       SA.Column('name_full', SA.String(64)),
                       SA.Column('city', SA.String(64)),
                       SA.Column('state', SA.String(64)),
                       SA.Column('country', SA.String(64)),
                   )

    SeriesPost = SA.Table('SeriesPost', metadata,
                          SA.Column('yearID', SA.Integer()),
                          SA.Column('round', SA.String(64)),
                          SA.Column('teamIDwinner', SA.String(64)),
                          SA.Column('lgIDwinner', SA.String(64)),
                          SA.Column('teamIDloser', SA.String(64)),
                          SA.Column('lgIDloser', SA.String(64)),
